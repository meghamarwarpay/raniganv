  ...
  return (
    <footer className="bg-dark text-light pt-5 mt-5">
      <div className="container">
        <div className="row">   
          ...
          <div className="col-md-4">
            <Image src={logo} style={{width:'100%',backgroundColor:'#ffff',borderRadius:'5px',padding:'10px'}}/>
          
            <p>If you have any question, please contact us at</p>
            <Link href="mailto:ranigaoninfotech@gmail.com" className="text-light d-block mb-2">
            Ranigaoninfotech@gmail.com
            </Link>
            <address>
            Plot No C 41 Manglam City Hatoj Kalwar Road Jaipur 302001
              
            </address>
            <Link href="tel:+91 9216514437" className="text-light">
              +91  9216514437
            </Link>
          </div>
      ...
      <div className="bg-dangers text-light text-center py-3 mt-4">
        <p className="mb-0">Copyright &copy; {new Date().getFullYear()} Ranigaon Infotech Private limited All Rights Reserved</p>
      </div>
    </footer>
  );
}
