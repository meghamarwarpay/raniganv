...
export default function Header() {
  ...
  useEffect(() => {
    ...
    const fetchCategories = async () => {
      try {
        ...
        const response = await apiGet('api/product4/getproducts4');
  ...
  const handleLogout = async () => {
    try {
      await apiPost("api/auth4/logOut4");
  ...
  return (
    <div className="headerfix">
      {/* Top Bar */}
      <div className="bg-dangers text-dark py-2 px-4 d-flex justify-content-end align-items-center">
        {isLoggedIn ? (
          <button
            onClick={handleLogout}
            className="btn btn-link text-dark mx-3 hover:text-primary"
          >
            Logout
          </button>
        ) : (
          <Link href="/login" className="text-dark hover:text-primary mx-3">
            Login
          </Link>
        )}
            ...
            >
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item">
                  <Link
                    href="/"
                    className="text-dark hover:text-primary mx-3"
                  >
                    Home
                  </Link>
                </li>
                ...
                <li className="nav-item">
                  <div
                    ...
                    className="text-dark hover:text-primary mx-3 droplinkstyle"
                  >
